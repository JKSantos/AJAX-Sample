...
public class CreateEmployeeAction extends ActionSupport{
	...
	public String execute(){
		...
		Employee emp;
		System.out.println(this.selectedJob.get(0));
		...
		emp = new Employee(1, strEmpLastName.trim().toUpperCase(), strEmpFirstName.trim().toUpperCase(), strEmpMiddleName.trim().toUpperCase(), datEmpBirthdate, strEmpGender, strEmpAddress.trim().toUpperCase(), strEmpContactNo, strEmpEmail, "A", strUser, strPass, file.getAbsolutePath(), null, selectedJob, chkGrantAccess);
